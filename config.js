...
thConfigModule.constant('configService', function() {
  ...
  o.root = '/th-frontend/'; //*** TODO: refactor when functionality becomes available in angular (see https://github.com/angular/angular.js/issues/2805)
  ...
  o.requests.urls = {
    ...
    //jobs
      candidates: requestUrlRoot + 'candidates',
    ...
    //lists
      ...
      candidatesAppLists: '/candidates/service/lists',
